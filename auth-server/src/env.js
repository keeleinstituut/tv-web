...
const ENV = {
  ...
  TRANSLATION_ORDER_SERVICE_BASE_URL: process.env.TRANSLATION_ORDER_SERVICE_BASE_URL,
  ...
  MACHINE_TRANSLATION_SERVICE_BASE_URL: process.env.MACHINE_TRANSLATION_SERVICE_BASE_URL,
  CAT2_SERVICE_BASE_URL: process.env.CAT2_SERVICE_BASE_URL,
