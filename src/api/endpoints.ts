export const endpoints = {
  ...
  CREATE_VENDORS: `${process.env.REACT_APP_TRANSLATION_ORDER_API_BASE}vendors/bulk`,
  DELETE_VENDORS: `${process.env.REACT_APP_TRANSLATION_ORDER_API_BASE}vendors/bulk`,
